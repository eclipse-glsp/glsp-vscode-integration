...
- The e2e suites are not part of /fix because they package both VSIX variants and download VS Code. Run them with `pnpm test:e2e` when changing anything under `e2e/` or the diagram integration itself.
