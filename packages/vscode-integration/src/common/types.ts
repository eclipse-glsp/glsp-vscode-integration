...
export interface GlspServerLauncherOptions {
 ...
 */
export interface GlspServerLauncher<T extends GlspServerLauncherOptions> extends vscode.Disposable {
    /**
     * Starts up the server.
     * @params options The launch options.
     * @returns A promise that resolves once the server startup is complete and the server is ready
     * to handle new connection(s).
     */
    start(options: T): Promise<unknown>;
    /**
     * Stops the server.
     */
    stop(): void;
